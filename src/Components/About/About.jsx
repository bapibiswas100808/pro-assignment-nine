        ...
        <div className="flex flex-col lg:flex-row-reverse justify-between items-center gap-5">
          ...
          >
            ...
            <p className="py-6 font-poppins text-lg">
              ...
              its client-focused approach, T-State offers personalized services,
              from property valuation to closing deals. Their expert team
              ensures seamless transactions, making it a trusted leader in the
